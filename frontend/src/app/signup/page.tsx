...
import TermCheckItem from "@/components/signup/TermCheckItem"
      ...
      <div className="mt-8 flex flex-col justify-end gap-6">
        ...
        <div className="flex flex-col gap-6">
          <TermCheckItem
            ...
            onChange={(checked) => handleTermCheck("all", checked)}
          />
          ...
          {TERM_CHECK_DATA.map((item) => (
            <TermCheckItem
              ...
              onChange={(checked) => handleTermCheck(item.type, checked)}
            />
          ))}
