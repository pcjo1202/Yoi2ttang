package com.ssafy.yoittang.tileinfo.application;
...
public class TileInfoService {
    ...
    @Transactional
    public void createTileInfo(int level) {
        ...
        for (char c : level3) {
            ...
            insertInfoBulk(geoHashStringList);
    ...
    void insertInfoBulk(ArrayList<String> geoHashStringList) {

        ArrayList<TileInfo> tileInfoArrayList = new ArrayList<>();
        ...
        tileInfoRepository.bulkInsert(tileInfoArrayList);
    }
