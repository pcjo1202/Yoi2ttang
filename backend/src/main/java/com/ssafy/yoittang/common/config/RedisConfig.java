...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, TileHistoryRedis> tileHistoryRedisRedisTemplate(RedisConnectionFactory factory) {
        RedisTemplate<String, TileHistoryRedis> redisTemplate = new RedisTemplate<>();
